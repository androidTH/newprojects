...
import kotlinx.android.synthetic.main.dialog_date_auth_tip_layout.*
 ...
 * 约会认证提示
 */
class DateAuthTipDialog : DialogFragment(),RequestManager {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? =
            inflater?.inflate(R.layout.dialog_date_auth_tip_layout, container, false)
