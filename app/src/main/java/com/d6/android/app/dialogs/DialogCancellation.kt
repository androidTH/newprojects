...
import kotlinx.android.synthetic.main.dialog_cancellation.*
 ...
 * 注销dialog
 */
class DialogCancellation : DialogFragment(), RequestManager, DialogInterface.OnKeyListener{
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? =
            inflater?.inflate(R.layout.dialog_cancellation, container, false)
...
//        }
        ...
        tv_cancellation_no.setOnClickListener {//不再提示
            dismissAllowingStateLoss()
        }

        tv_cancellation_yes.setOnClickListener {
