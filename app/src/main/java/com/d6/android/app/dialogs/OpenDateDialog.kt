...
class OpenDateDialog : DialogFragment(),RequestManager {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
       ...
       if(arguments !=null){
           ...
           tv_agree_points.text = "达成邀约,扣除预付${it.iAppointPoint}积分"
           tv_noagree_points.text = "对方拒绝,返还${it.iAppointPointRefuse}积分"//${it.iAppointPointRefuse}
           tv_timeout_points.text = "3天后未回复,返还${it.iAppointPointCancel}积分"
        }
    }
