...
public class DragStrokeView extends AppCompatTextView {
    ...
    public DragStrokeView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initbg();
    }
    ...
    public void setBackgroundColor(int backgroundColor) {
        ...
        DragStrokeView.this.setBackgroundDrawable(createStateListDrawable((getHeight() > getWidth() ? getHeight()
    ...
    private void initbg() {
        ...
        getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
            ...
            public boolean onPreDraw() {
                if (!initBgFlag) {
                    DragStrokeView.this.setBackgroundDrawable(createStateListDrawable(
        ...
        public void cancel() {
            ...
            set.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    DragStrokeView.this.setVisibility(View.VISIBLE);
                }
            });
            set.start();
    ...
    public static StateListDrawable createStateListDrawable(int radius, int color) {
        ...
        gradientStateNormal.setStroke(2, Color.parseColor("#ffffff"));
