 ...
 *粉丝
 */
class RedHeartRuleAdapter(mData:ArrayList<PointRule>): HFRecyclerAdapter<PointRule>(mData, R.layout.item_list_redheartrule){

    override fun onBind(holder: ViewHolder, position: Int, data: PointRule) {
        holder.setText(R.id.tv_readheart_nums,"${data.iPoint.toString()}")
