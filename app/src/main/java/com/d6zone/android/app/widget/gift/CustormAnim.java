package com.d6zone.android.app.widget.gift;
...
import com.d6zone.android.app.widget.gift.animutils.GiftAnimationUtil;
...
//        ObjectAnimator animator1 = ObjectAnimator.ofPropertyValuesHolder(giftFrameLayout, alpha);//translationY,
