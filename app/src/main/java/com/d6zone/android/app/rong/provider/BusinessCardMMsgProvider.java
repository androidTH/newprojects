...
import com.d6zone.android.app.adapters.CardChatManTagAdapter;
import com.d6zone.android.app.adapters.ChatDatelmageAdapter;
import com.d6zone.android.app.models.UserData;
import com.d6zone.android.app.models.UserTag;
            ...
            try {
                ...
                if (TextUtils.equals("0", mUserData.getSex())) {//女性
                    ...
                    if (TextUtils.equals(mUserData.getUserclassesid(), "27")) {
                        ...
                        holder.tv_chat_men_vip.setBackground(ContextCompat.getDrawable(v.getContext(), R.mipmap.app_vip));
                    }
                } else {
                    if (TextUtils.equals(mUserData.getUserclassesid(), "22")) {
                        ...
                        holder.tv_chat_men_vip.setBackground(ContextCompat.getDrawable(v.getContext(), R.mipmap.ruqun_icon));
                    }else if (TextUtils.equals(mUserData.getUserclassesid(), "31")) {
                        holder.tv_chat_men_vip.setBackground(ContextCompat.getDrawable(v.getContext(), R.mipmap.app_vip));
                    }
                }
