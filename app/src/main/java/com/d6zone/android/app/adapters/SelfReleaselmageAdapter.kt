...
import com.d6zone.android.app.activities.ImagePagerActivity
import com.d6zone.android.app.activities.TrendDetailActivity
 ...
 *
 */
class SelfReleaselmageAdapter(mData: ArrayList<String>, val type:Int = 0) : HFRecyclerAdapter<String>(mData, R.layout.item_list_selfrelease_image) {
