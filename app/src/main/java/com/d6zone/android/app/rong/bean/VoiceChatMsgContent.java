...
public class VoiceChatMsgContent extends MessageContent {
    ...
    public VoiceChatMsgContent() {
    }

    public static VoiceChatMsgContent obtain(String text, String json) {
        VoiceChatMsgContent model = new VoiceChatMsgContent();
        model.setContent(text);
        model.extra = json;
        return model;
    }

    public VoiceChatMsgContent(byte[] data) {
        String jsonStr = null;
        try {
     ...
     */
    public VoiceChatMsgContent(Parcel in) {
     ...
     */
    public static final Creator<VoiceChatMsgContent> CREATOR = new Creator<VoiceChatMsgContent>() {

        @Override
        public VoiceChatMsgContent createFromParcel(Parcel source) {
            return new VoiceChatMsgContent(source);
        }

        @Override
        public VoiceChatMsgContent[] newArray(int size) {
            return new VoiceChatMsgContent[size];
        }
    };
     ...
     */
    public VoiceChatMsgContent(String content) {
