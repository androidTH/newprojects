package com.d6zone.android.app.net

import com.d6zone.android.app.models.Response
...
//        }
    ...
    fun releaseSquare(userId: String, classesId: String?, city: String?, imgUrl: String?, content: String,sAppointUser:String,iIsAnonymous:Int
                      ,sTopicId:String,sVideoUrl:String,sVideoPicUrl:String,sVideoWidth:String,sVideoHeight:String,sVoiceUrl:String,sVoiceLength:String,sIfLovePics:String,sIfSeePics:String,orderType:Int,rankOrder:Int,orderNum:Int,lovePointNum:Int) =
            RRetrofit.instance().create(ApiServices::class.java).releaseSquare(userId, classesId, city, imgUrl, content,sAppointUser,iIsAnonymous,
                    sTopicId,sVideoUrl,sVideoPicUrl,sVideoWidth,sVideoHeight,sVoiceUrl,sVoiceLength,sIfLovePics,sIfSeePics,orderType,rankOrder,orderNum,lovePointNum)
    ...
    fun getProvinceAll(isShow:String) =
            RRetrofit.instance().create(ApiServices::class.java).getProvinceAll(isShow)
