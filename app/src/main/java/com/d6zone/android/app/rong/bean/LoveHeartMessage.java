...
@MessageTag(value = "app:loveMessage", flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
public class LoveHeartMessage extends MessageContent {
    ...
    public LoveHeartMessage() {
    }

    public static LoveHeartMessage obtain(String text, String json) {
        LoveHeartMessage model = new LoveHeartMessage();
        model.setContent(text);
        model.extra = json;
        return model;
    }

    public LoveHeartMessage(byte[] data) {
        String jsonStr = null;
        try {
     ...
     */
    public LoveHeartMessage(Parcel in) {
     ...
     */
    public static final Creator<LoveHeartMessage> CREATOR = new Creator<LoveHeartMessage>() {

        @Override
        public LoveHeartMessage createFromParcel(Parcel source) {
            return new LoveHeartMessage(source);
        }

        @Override
        public LoveHeartMessage[] newArray(int size) {
            return new LoveHeartMessage[size];
        }
    };
     ...
     */
    public LoveHeartMessage(String content) {
