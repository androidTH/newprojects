...
public class GroupUnKnowTipsMessage extends MessageContent {
    ...
    public GroupUnKnowTipsMessage() {
    }

    public static GroupUnKnowTipsMessage obtain(String text, String json) {
        GroupUnKnowTipsMessage model = new GroupUnKnowTipsMessage();
        model.setContent(text);
        model.extra = json;
        return model;
    }

    public GroupUnKnowTipsMessage(byte[] data) {
        String jsonStr = null;
        try {
     ...
     */
    public GroupUnKnowTipsMessage(Parcel in) {
     ...
     */
    public static final Creator<GroupUnKnowTipsMessage> CREATOR = new Creator<GroupUnKnowTipsMessage>() {

        @Override
        public GroupUnKnowTipsMessage createFromParcel(Parcel source) {
            return new GroupUnKnowTipsMessage(source);
        }

        @Override
        public GroupUnKnowTipsMessage[] newArray(int size) {
            return new GroupUnKnowTipsMessage[size];
        }
    };
     ...
     */
    public GroupUnKnowTipsMessage(String content) {
