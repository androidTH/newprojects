 ...
 */
@MessageTag(value = "app:SystemMessage", flag = MessageTag.NONE)
public class CustomSystemMessage extends MessageContent {
    ...
    public static CustomSystemMessage obtain(String text, String json) {
     ...
     */
    public CustomSystemMessage(Parcel in) {
     ...
     */
    public CustomSystemMessage(String content) {
