package com.d6zone.android.app.widget.layoutbanner;
...
import com.d6zone.android.app.widget.layoutbanner.layoutmanager.BannerLayoutManager;
import com.d6zone.android.app.widget.layoutbanner.layoutmanager.CenterSnapHelper;
...
//            selectedGradientDrawable.setCornerRadius(dp2px(5) / 2);
            mSelectedDrawable = ContextCompat.getDrawable(context,R.mipmap.ic_page_indicator_focused);
        }
...
//            unSelectedGradientDrawable.setCornerRadius(dp2px(5) / 2);
            mUnselectedDrawable  = ContextCompat.getDrawable(context,R.mipmap.ic_page_indicator);
        }
