package com.d6zone.android.app.widget.pullleftrefresh;
 ...
 * time   : 2020/10/28
 * desc   :
 * version: github:https://github.com/yzl520/PullLeftToRefreshLayout
 */
public class PullLeftToRefreshLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        moreViewMarginRight = -getResources().getDimensionPixelSize(R.dimen.margin_25);
