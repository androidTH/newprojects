package com.d6zone.android.app.rong.voicechat;
...
import com.d6zone.android.app.models.VoiceTips;
...
import com.d6zone.android.app.widget.LoveHeart;
import com.d6zone.android.app.widget.blurry.internal.Helper;
...
import static com.d6zone.android.app.utils.UtilKt.updateSquareSignUp;
...
//    }
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.voice_voip_user_portrait){
            ...
            intent.putExtra("fromType", Const.SENDLOVEHEART_DIALOG);
            startActivity(intent);
