...
public class CommentSquareMsgProvider extends IContainerItemProvider.MessageProvider<CommentMsgContent> {
    private static final String TAG = CommentSquareMsgProvider.class.getSimpleName();

    @Override
    public View newView(Context context, ViewGroup group) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_squarecomment_card, null);
        CommentSquareMsgProvider.ViewHolder holder = new CommentSquareMsgProvider.ViewHolder();
    ...
    public void bindView(final View v, int position, final CommentMsgContent content, final UIMessage data) {
        ViewHolder holder = (CommentSquareMsgProvider.ViewHolder) v.getTag();
    ...
    public void onItemLongClick(final View view, int position, final CommentMsgContent content, final UIMessage message) {
        ...
        CommentSquareMsgProvider.ViewHolder holder = (CommentSquareMsgProvider.ViewHolder) view.getTag();
