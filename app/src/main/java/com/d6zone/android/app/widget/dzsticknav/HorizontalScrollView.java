package com.d6zone.android.app.widget.dzsticknav;
...
public class HorizontalScrollView extends RelativeLayout {
    ...
    public HorizontalScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mOffsetWidth = -DisplayUtil.dp2px(context, 65);
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mMoreTextView != null) {
            ...
            mOffsetWidth = mOffsetWidth == 0 ? -DisplayUtil.dp2px(getContext(), 65) : mOffsetWidth;
        }
    }
