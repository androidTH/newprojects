package com.d6zone.android.app.widget.shadow;
...
public class ShadowTextView extends View {
    ...
    private void initView(AttributeSet attrs) {
        ...
        mTextColor =  a.getColor(R.styleable.ShadowTextView_shadowTextColor, getResources().getColor(R.color.white));
    ...
    private void setMaskPaint() {
        ...
        mMaskPaint.setShadowLayer(mMaskRadius/2,dx,dy,getResources().getColor(R.color.white));
    }
