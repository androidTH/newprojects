...
@MessageTag(value = "app:CustomTipsMsg", flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
public class TipsMessage extends MessageContent {
    ...
    public static TipsMessage obtain(String text, String json) {
        TipsMessage model = new TipsMessage();
        model.setContent(text);
        model.extra = json;
        return model;
    }

    public TipsMessage(byte[] data) {
        String jsonStr = null;
        try {
     ...
     */
    public static final Creator<TipsMessage> CREATOR = new Creator<TipsMessage>() {

        @Override
        public TipsMessage createFromParcel(Parcel source) {
            return new TipsMessage(source);
        }

        @Override
        public TipsMessage[] newArray(int size) {
            return new TipsMessage[size];
        }
    };
     ...
     */
    public TipsMessage(String content) {
