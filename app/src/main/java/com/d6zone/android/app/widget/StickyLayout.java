...
public class StickyLayout extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        mContentView = (ViewPager) findViewById(R.id.mViewPager);
        mHeaderView = (LinearLayout) findViewById(R.id.ll_header);
        mStickyView = (TabLayout) findViewById(R.id.tab_home_date);
    }
...
//        HomeDatePageAdapter adapter = (HomeDatePageAdapter) mContentView.getAdapter();
