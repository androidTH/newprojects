...
public class GiftRongIMMessage extends MessageContent {
    ...
    public GiftRongIMMessage() {
    }

    public static GiftRongIMMessage obtain(String text, String json) {
        GiftRongIMMessage model = new GiftRongIMMessage();
        model.setContent(text);
        model.extra = json;
        return model;
    }

    public GiftRongIMMessage(byte[] data) {
        String jsonStr = null;
        try {
     ...
     */
    public GiftRongIMMessage(Parcel in) {
     ...
     */
    public static final Creator<GiftRongIMMessage> CREATOR = new Creator<GiftRongIMMessage>() {

        @Override
        public GiftRongIMMessage createFromParcel(Parcel source) {
            return new GiftRongIMMessage(source);
        }

        @Override
        public GiftRongIMMessage[] newArray(int size) {
            return new GiftRongIMMessage[size];
        }
    };
     ...
     */
    public GiftRongIMMessage(String content) {
