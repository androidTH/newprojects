...
import com.d6zone.android.app.BuildConfig
...
import com.d6zone.android.app.interfaces.VoiceChatStatus
import com.d6zone.android.app.models.*
import com.d6zone.android.app.net.Request
import com.d6zone.android.app.net.http.UpdateAppHttpUtil
import com.d6zone.android.app.rong.bean.TipsMessage
import com.d6zone.android.app.rong.bean.TipsTxtMessage
import com.d6zone.android.app.utils.Const.DEBUG_MODE
import com.d6zone.android.app.utils.Const.NO_VIP_FROM_TYPE
import com.d6zone.android.app.utils.Const.User.ISNOTFREECHATTAG
import com.d6zone.android.app.utils.Const.User.IS_FIRST_FAST_CLICK
import com.d6zone.android.app.utils.Const.User.IS_FIRST_SHOW_FINDDIALOG
import com.d6zone.android.app.utils.Const.User.IS_FIRST_SHOW_SELFDATEDIALOG
import com.d6zone.android.app.utils.Const.User.OAID_ANDROID
import com.d6zone.android.app.utils.JsonUtil.containsEmoji
import com.d6zone.android.app.widget.CustomToast
import com.d6zone.android.app.widget.CustomToast.showToast
import com.d6zone.android.app.widget.diskcache.DiskLruCacheHelper
...
fun checkKFService(mOtherUserId:String):Boolean{
    if(TextUtils.equals(getUserSex(),"0")){
        if(!TextUtils.equals(mOtherUserId, Const.CustomerServiceWomenId)){
            return true
        }
    }else if(TextUtils.equals(getUserSex(),"1")){
        if(!TextUtils.equals(mOtherUserId, Const.CustomerServiceId)){
            return true
        }
    }
    return false
