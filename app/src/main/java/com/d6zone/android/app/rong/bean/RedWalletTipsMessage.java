...
public class RedWalletTipsMessage extends MessageContent {
    ...
    public RedWalletTipsMessage() {
    }

    public static RedWalletTipsMessage obtain(String text, String json) {
        RedWalletTipsMessage model = new RedWalletTipsMessage();
        model.setContent(text);
        model.extra = json;
        return model;
    }

    public RedWalletTipsMessage(byte[] data) {
        String jsonStr = null;
        try {
     ...
     */
    public RedWalletTipsMessage(Parcel in) {
     ...
     */
    public static final Creator<RedWalletTipsMessage> CREATOR = new Creator<RedWalletTipsMessage>() {

        @Override
        public RedWalletTipsMessage createFromParcel(Parcel source) {
            return new RedWalletTipsMessage(source);
        }

        @Override
        public RedWalletTipsMessage[] newArray(int size) {
            return new RedWalletTipsMessage[size];
        }
    };
     ...
     */
    public RedWalletTipsMessage(String content) {
